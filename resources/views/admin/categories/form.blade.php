<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <nav class="flex items-center gap-2 text-sm text-gray-500 mb-6">
        ...
        <a href="{{ route('admin.categories') }}" wire:navigate class="hover:text-primary-600 transition-colors">Categories</a>
        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"/></svg>
        <span class="text-gray-900 font-medium">{{ $categoryId ? 'Edit: ' . ($name ?? 'Category') : 'Create Category' }}</span>
    </nav>
