    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title|target|rel],ul,ol,li,p[style],br,span[style],img[width|height|alt|src|class],blockquote,div[style|class|id],pre,hr,sub,sup,code,table[style|class],thead,tbody,tfoot,tr,td[style|class|colspan|rowspan],th[style|class|colspan|rowspan],figure,figcaption',
            'HTML.ForbiddenElements' => 'script,style,iframe,object,embed,form,input,textarea,select,button',
            'CSS.AllowedProperties' => 'font,font-size,font-weight,font-style,font-family,text-decoration,padding-left,color,background-color,text-align,width,height,margin,margin-left,margin-right,margin-top,margin-bottom,padding,padding-top,padding-right,padding-bottom,padding-left,border,border-collapse,list-style-type,float,vertical-align,line-height,letter-spacing,text-transform,word-spacing,white-space',
